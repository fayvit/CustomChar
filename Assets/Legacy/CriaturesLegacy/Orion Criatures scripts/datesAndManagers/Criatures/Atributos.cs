...
public class Atributos
{
    ...
    [SerializeField]AtributoInstrinsico ataque;
    [SerializeField]AtributoInstrinsico defesa;
    [SerializeField]AtributoInstrinsico poder;
    ...
    public AtributoInstrinsico Ataque
    {
        get { return ataque; }
        set { ataque = value; }
    }

    public AtributoInstrinsico Defesa
    {
        get { return defesa; }
        set { defesa = value; }
    }
    ...
    public AtributoInstrinsico Poder
    {
        get { return poder; }
        set { poder = value; }
    }
...
public class ContainerDeAtributos
{
    ...
    public AtributoInstrinsico ataque = new AtributoInstrinsico(9);
    public AtributoInstrinsico defesa = new AtributoInstrinsico(9);
    public AtributoInstrinsico poder = new AtributoInstrinsico(9);
}
...
[System.Serializable]
public class AtributoInstrinsico
{
    [SerializeField]int corrente;
    ...
    public AtributoInstrinsico(int corrente, float taxa = 0.2f, int maximo = 0,
