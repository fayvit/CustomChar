...
namespace FayvitMove_10_2020
{
    ...
    public class JumpManager
    {
        ...
        public void StartApplyJump()
        {
            ...
            FayvitMoveEventAgregator.Publish(new FayvitMoveEvent(FayvitMoveEventKey.animateStartJump,controle.gameObject));
        }
        ...
        public void NotJumping()
        {
            ...
            if (features.isJumping)
                FayvitMoveEventAgregator.Publish(new FayvitMoveEvent(FayvitMoveEventKey.animateDownJump,controle.gameObject));
