...
namespace Criatures2021
{
    public class PetAttackManager
    {
        ...
        [SerializeField] public List<PetAttackDb> listaDeGolpes;
        [SerializeField] public List<PetAttackBase> meusGolpes;


        List<PetAttackDb> ListaDeGolpesAtualizada(PetName nome)
        {
            Debug.LogError("Elemetno por fazer");
            return new List<PetAttackDb>();
                
                //PetFactory.GetPet(nome).
