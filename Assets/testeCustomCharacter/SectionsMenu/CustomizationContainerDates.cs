...
public class CustomizationContainerDates
{
    ...
    public void Save()
    {
        LoadAndSaveGame.SalvarArquivo("CutomizationDates.ccd", this);
    }

    public void Load()
    {
        CustomizationContainerDates ccd = LoadAndSaveGame.CarregarArquivo<CustomizationContainerDates>("CutomizationDates.ccd");
...
public struct ToSaveCustomizationContainer
{
    ...
    public void Load()
    {
        List<CustomizationContainerDates> ccds = LoadAndSaveGame.CarregarArquivo<List<CustomizationContainerDates>>("osCustomizados.tsc", Application.dataPath);
        if (ccds != null)
            instance.ccds = ccds;
